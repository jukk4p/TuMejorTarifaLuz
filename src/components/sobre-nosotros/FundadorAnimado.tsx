...
export default function FundadorAnimado() {
  return (
    <div className="grid sm:grid-cols-3 gap-6 pt-12">
      <div className="p-8 bg-surface-2 rounded-3xl border border-border flex flex-col items-center justify-center text-center group hover:border-primary/50 transition-colors">
