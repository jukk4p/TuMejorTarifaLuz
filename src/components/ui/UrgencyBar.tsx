...
export default function UrgencyBar() {
  ...
  return (
    <div className="bg-section-dark border-y border-primary/10 py-6 relative overflow-hidden group shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
      {/* Subtle background effect */}
      <div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-transparent to-primary/10 opacity-10 pointer-events-none"></div>
