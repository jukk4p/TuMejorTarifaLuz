                ...
                {step === "input" && inputMethod && (
                    <div className="flex flex-col lg:flex-row gap-8 animate-in fade-in duration-500">
                        <aside className="w-full lg:w-[400px] shrink-0 flex flex-col">
                            <div className={`premium-card bg-dot-pattern p-6 flex-1 h-full flex flex-col shadow-2xl shadow-primary/20 transition-all duration-700 hover:shadow-primary/30 relative overflow-hidden ${isProcessing ? 'shadow-inner' : ''}`}>
                                {isProcessing && (
                                    <div className="absolute inset-0 z-30 pointer-events-none overflow-hidden">
                                        <div className="absolute inset-0 bg-primary/[0.02] backdrop-blur-[1px]"></div>
                                        <div className="absolute w-full h-1/3 bg-gradient-to-b from-transparent via-primary/10 to-transparent animate-[scan_2s_ease-in-out_infinite]"></div>
                                        <div className="absolute inset-0 border-2 border-primary/20 animate-pulse rounded-[1.5rem]"></div>
                                    </div>
                                )}
                                ...
                                <div className={`relative z-10 flex-1 flex flex-col transition-all duration-700 ${isProcessing ? 'opacity-40 blur-[1px]' : ''}`}>
                                    <div className="flex items-center justify-between mb-8">
                                        ...
                                        <button 
                                            onClick={() => {
                                                setInputMethod(prev => prev === "manual" ? "upload" : "manual");
                        ...
                        <section className="flex-1 flex flex-col space-y-6">
                            {(inputMethod === "upload" && !hasAnalyzed && !isProcessing) ? (
                                <div className="premium-card p-6 md:p-14 relative overflow-hidden flex flex-col items-center justify-center text-center flex-1 h-full min-h-[440px] max-w-[720px] mx-auto group !border-none shadow-2xl shadow-primary/20 hover:shadow-primary/30 transition-all duration-500">
                                ...
                                <div className="premium-card bg-grid-pattern p-6 md:p-14 relative overflow-hidden flex flex-col items-center justify-center text-center flex-1 h-full min-h-[440px] max-w-[720px] mx-auto group !border-none shadow-2xl shadow-primary/20 hover:shadow-primary/30 transition-all duration-500">
                                ...
                                <div className="premium-card p-8 space-y-8">
                                    <div className="space-y-5">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={handleInputChange}
                                                        className="w-full bg-white dark:bg-slate-900/40 border border-slate-200/60 dark:border-white/5 rounded-2xl px-4 py-2.5 text-sm font-mono focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all outline-none shadow-sm shadow-slate-200/20"
                                                    />
                                                </div>
                                                <div className="space-y-1.5">
                                                    <div className="flex items-center gap-1">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-3 gap-3">
                                                <div className="space-y-1.5">
                                                    <label className="text-[10px] font-bold text-text-secondary uppercase opacity-60">Punta</label>
                                                    <input
                                                        type="text"
                                                        inputMode="decimal"
                                                        name="energy_p1"
                                                        ...
                                                        onChange={handleInputChange}
                                                        className="w-full bg-white dark:bg-slate-900/40 border border-slate-200/60 dark:border-white/5 rounded-xl px-3 py-2 text-xs font-mono focus:border-primary outline-none shadow-sm"
                                                    />
                                                </div>
                                                <div className="space-y-1.5">
                                                    <label className="text-[10px] font-bold text-text-secondary uppercase opacity-60">Llano</label>
                                                    <input
                                                        type="text"
                                                        inputMode="decimal"
                                                        name="energy_p2"
                                                ...
                                                <div className="space-y-1.5">
                                                    <label className="text-[10px] font-bold text-text-secondary uppercase opacity-60">Valle</label>
                                                    <input
                                                        type="text"
                                                        inputMode="decimal"
                                                        name="energy_p3"
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="relative group/input">
                                                        ...
                                                        <input
                                                            ...
                                                            className="relative w-full bg-surface-2/40 border border-border rounded-2xl pl-11 pr-4 py-3 text-sm outline-none focus:border-primary focus:bg-white transition-all text-text-primary placeholder:text-text-muted/70"
                                                        />
                                                    </div>
                                                </div>
                                        ...
                                        <div className="w-32 h-32 md:w-32 md:h-32 rounded-2xl bg-surface border border-border flex items-center justify-center p-4 md:p-6 shrink-0 shadow-sm relative z-10 mx-auto md:mx-0">
                                            {selectedResult.tariff.logo_url ? (
                                                ...
                                                <div className="relative flex items-center justify-center w-full h-full p-2">
                                                    <img
                                                        src={getLogoPath(selectedResult.tariff.company, mounted && resolvedTheme === 'dark') || '/logos/COR.svg'}
                                                        alt={selectedResult.tariff.company}
                                                        className="w-full h-full object-contain relative z-10"
                                                    />
                                                </div>
