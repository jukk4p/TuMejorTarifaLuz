...
export interface Provider {
    ...
    logo_dark?: string;
    rating: number;
    trustpilotReviewCount?: number; // nº de opiniones en Trustpilot (aprox., el contador crece constantemente)
    description: string;
    pros: string[];
    prosDetail?: string[];
    cons: string[];
...
const staticProviders: Provider[] = [
    ...
    },
    {
        id: "gana-energia",
        name: "Gana Energía",
        logo: "/logos/gana-logo.svg",
        logo_dark: "/logos/gana-logo-dark.svg",
        rating: 4.6,
        trustpilotReviewCount: 7000,
        description: "Comercializadora valenciana con más de medio millón de clientes y call center propio. Ofrece tarifas sin permanencia y un descuento adicional con código promocional durante los primeros meses.",
        pros: ["Atención telefónica propia en Valencia", "Sin permanencia", "Gestión 100% online", "Descuento adicional con código promocional"],
        prosDetail: ["Call center propio", "Libertad total de cambio de compañía", "App y área de cliente", "Código DESC100: 10% durante los primeros 10 meses"],
        cons: ["Red de oficinas físicas reducida", "Alguna incidencia puntual de facturación en reseñas"],
        consDetail: ["Modelo mayormente digital", "Casos aislados según Trustpilot"],
        slug: "gana-energia",
        color: "#f59e0b",
        minPrice: 0.09,
        category: 'independent',
        hasPermanence: false,
        popularTariffName: "Tramos Horarios",
        trustpilotUrl: "https://es.trustpilot.com/review/ganaenergia.com",
        scores: { price: 4.4, support: 4.6, app: 4.3, transparency: 4.0, onboarding: 4.5 }
    },
    {
        id: "chc-energia",
        name: "CHC Energía",
        logo: "/logos/logo_chcenergia.png",
        rating: 2.3,
        trustpilotReviewCount: 8,
        description: "Comercializadora con más de 140 oficinas físicas en zonas rurales y municipios medianos, especializada en trato de proximidad. Sus opiniones online son más variables que la media del sector, con quejas puntuales sobre claridad de facturación.",
        pros: ["Amplia red de oficinas físicas", "Trato de proximidad en zonas rurales", "Planes dúo de luz y gas", "Batería virtual para excedentes solares"],
        prosDetail: ["Más de 140 oficinas", "Presencia en municipios pequeños", "Factura conjunta luz + gas", "Compensación de excedentes acumulable en saldo"],
        cons: ["Reseñas online más bajas que la media del sector", "Quejas sobre claridad de facturación", "Tiempos de espera en atención telefónica según algunas reseñas"],
        consDetail: ["Valoración media mixta entre plataformas", "Casos reportados de dudas en factura", "Variable según oficina"],
        slug: "chc-energia",
        color: "#1e40af",
        minPrice: 0.1199,
        category: 'independent',
        hasPermanence: false,
        popularTariffName: "Plan Estrella Dúo",
        trustpilotUrl: "https://es.trustpilot.com/review/chcenergia.es",
        scores: { price: 4.0, support: 3.4, app: 3.0, transparency: 3.2, onboarding: 3.6 }
    }
];
